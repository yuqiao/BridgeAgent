...
9. [阶段 3–7 实施计划](stages/03-07-delivery-plan.md)：已确认的测试边界、review 与逐阶段发布约定。
...
设计与实施日期：2026-09-25。应用配置采用 YAML 显式装配；阶段 3.5 提供基础 Skills，阶段 5 扩展修改与脚本执行，阶段 7 实现 Cordis 风格动态插件机制。
...
- [动态插件指南](guides/dynamic-plugins.md)
- [7.2 Context 与动态依赖](stages/07.2-dynamic-context.md)
- [7.3 事件与资源](stages/07.3-events-effects.md)
- [7.4 配置树与重载](stages/07.4-reload.md)
- [7.5 集成验收与最终 review](stages/07.5-integration.md)
